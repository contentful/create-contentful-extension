...
describe('App', () => {
  ...
  it('should read a values from entry.fields.*', () => {
    ...
    expect((getByTestId('field-title') as HTMLInputElement).value).toEqual(
      'title-value'
    );
    expect((getByTestId('field-body') as HTMLInputElement).value).toEqual(
      'body-value'
    );
    expect((getByTestId('field-abstract') as HTMLInputElement).value).toEqual(
      'abstract-value'
    );
